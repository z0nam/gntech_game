    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ult1_4_group', to='otree.Session')),
            ],
            options={
                'db_table': 'ult1_4_group',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model, ult.models.Group),
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='ult1_4.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ult1_4_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ult1_4_player', to='otree.Session')),
            ],
            options={
                'db_table': 'ult1_4_player',
            },
            bases=(otree_save_the_change.mixins.SaveTheChange, models.Model, ult.models.Player),
        ),
        migrations.CreateModel(
            name='Subsession',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ult1_4_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'ult1_4_subsession',
            },
        ...
        migrations.AddField(
            model_name='player',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ult1_4.Subsession'),
        ),
        migrations.AddField(
            model_name='group',
            name='subsession',
